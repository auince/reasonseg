...
class HICOEvaluator(object):
    ...
    def accumulate(self):
        ...
        with open('hico_ap.pkl', 'wb') as f:
            pickle.dump(self.hico_ap, f)

        with open('hico_rec.pkl', 'wb') as f:
            pickle.dump(self.hico_rec, f)
    ...
    def summarize(self, epoch):
        ...
        log_stats = {
            "epoch" + str(epoch) + "  zero-shot mAP: " : zero_shot_mAP * 100.,
            "seen mAP: " : seen_mAP * 100.,
            "full mAP: " : np.mean(self.hico_ap[valid_hois]) * 100.
        }
