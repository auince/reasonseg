...
coco_root = '/vast/palmer/scratch/panda/sx275/datasets/seg-datasets/coco'
ref_root = '/vast/palmer/scratch/panda/sx275/datasets/seg-datasets/refcocoseg'
...
refg_val_ids = refg.getRefIds(split='train')
