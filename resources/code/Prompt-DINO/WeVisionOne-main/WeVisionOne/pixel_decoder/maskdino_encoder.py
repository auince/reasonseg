...
from .maskdino_early_fusion import MSDeformAttnTransformerEncoderLayer
...
class MaskDINOEncoder(nn.Module):
    ...
    def forward_features(self, features, masks, txt_feats=None):
        """
        ...
        srcsl = []
        posl = []
        # self.total_num_feature_levels 5
        ...
        for o in out:
            if num_cur_levels < self.total_num_feature_levels:
                ...
                num_cur_levels += 1
        return self.mask_features(out[-1]), out[0], multi_scale_features, txt_feats
