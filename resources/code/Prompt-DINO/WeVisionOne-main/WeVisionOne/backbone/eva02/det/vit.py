...
class Detectron2LayerNorm(nn.Module):
    """
...
def get_norm(norm, out_channels):
    norm_mapping = {
        "LN": Detectron2LayerNorm,
    }
    return norm_mapping[norm](out_channels)
...
class EVA2_VitDetLarge1024(Backbone):
    """
    ...
    def __init__(self, cfg, input_shape):
        ...
        """
        super(EVA2_VitDetLarge1024, self).__init__()
